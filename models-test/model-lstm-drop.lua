...
function AttnLayer(attnLayerSize)
...
function BiLangModelLSTMAvgAttn:__init(vsizePri,vsizeSec,seq_lenPri,seq_lenSec,prm_list)  
  ...
  self.attnLayerPri,self.attnWeightsPri = AttnLayer(prm_list["hidden_size"])
  ...
  self.attnLayerSec,self.attnWeightsSec = AttnLayer(prm_list["hidden_size"])
