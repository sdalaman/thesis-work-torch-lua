...
--10000 tok
modelEnFile10000Tok = 
"/home/saban/work/additive/model-impl/lstm-models/model-files/10000/En/10-Bilstm-Sc-Avg(64-128)-Tok-Morph/en-tu_en_0.001_750.lstm.64.128.60.BiLstmSc-Avg-drop-10000.model"
vocabEnFile10000Tok =  "/home/saban/work/additive/models/corpus/english.10000.tok.en-tu.60.BiLstm.vocab"
lookupEnFile10000Tok = "/home/saban/work/additive/model-impl/lstm-models/model-files/10000/En/10-Bilstm-Sc-Avg(64-128)-Tok-Morph/en-tu_en_0.001_750.lstm.64.128.60.BiLstmSc-Avg-drop-10000.LT"

--10000 morph
modelEnFile10000TokMorph = 
"/home/saban/work/additive/model-impl/lstm-models/model-files/10000/En/10-Bilstm-Sc-Avg(64-128)-Tok-Morph/en-tu_en_1e-05_1400.lstm.64.128.60.BiLstmSc-Avg-drop-10000-morph.model"
vocabEnFile10000TokMorph =  "/home/saban/work/additive/models/corpus/english.10000.tok.morph.en-tu.60.BiLstm.vocab"
lookupEnFile10000TokMorph = "/home/saban/work/additive/model-impl/lstm-models/model-files/10000/En/10-Bilstm-Sc-Avg(64-128)-Tok-Morph/en-tu_en_1e-05_1400.lstm.64.128.60.BiLstmSc-Avg-drop-10000-morph.LT"
...
if false then
  scenariosT={}
scenariosT[#scenariosT+1] = { lr = 0.01;prev_lr = 0;alpha = 0.95;lr_decay = 0;weight_decay = 0; lr_list = nil ;emb_size = 64;hidden_size = 128;num_of_hidden=1;out_size = 128;gate_type = 'LSTM';short_cut=1;momentum=0.5; threshold = 50 ;dump_frq = 50;max_epoch = 150;epoch=0;batch_size = 50;init = 1;max_seq_len = config.max_sntc_len;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;err_test_size = 1000;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10;coefL1=0;coefL2=0;fhead="";dropoutProb=0.5}

  prm_list = scenariosT[1]
  ltEnT = torch.load(lookupEnFile)
  ltEnT:cuda()
  modelT = BiLangModelBiLSTMScAvg2(ltEnT.weight:size()[1]-1,10,config.max_sntc_len,config.max_sntc_len,prm_list)  
...
--  fileList = fileListTstSmpEnDe  -- ****************
  ...
  for fcnt = 1,#fileList do
    ...
    if f1 and f2 then
      ...
      testinputs1,_ = testcorpus_shapedataBiLSTM(vocab1,testcorpus1):cuda()
      testinputs2,_ = testcorpus_shapedataBiLSTM(vocab2,testcorpus2):cuda()
...
--corpus_name1 = corpus_path..corpus1_str.."."..max_sentence_len..".Bilstm.corpus.tch"
--inputs_name1 = corpus_path..corpus1_str.."."..max_sentence_len..".Bilstm.inputs.tch"

if morph == true then
  vocab2 = corpus_path..corpus2_str..".morph."..max_sentence_len..".Bilstm.vocab" -- vocab file  for lang 2
  corpus_name2 = corpus_path..corpus2_str..".morph."..max_sentence_len..".Bilstm.corpus.tch"
  inputs_name2 = corpus_path..corpus2_str..".morph."..max_sentence_len..".Bilstm.inputs.tch"
else
  vocab2 = corpus_path..corpus2_str.."."..max_sentence_len..".Bilstm.vocab" -- vocab file  for lang 2
  corpus_name2 = corpus_path..corpus2_str.."."..max_sentence_len..".Bilstm.corpus.tch"
  inputs_name2 = corpus_path..corpus2_str.."."..max_sentence_len..".Bilstm.inputs.tch"
end
...
if config.dtype ~= "tok.morph" then
--for 10000 BIAVG 1 tok
--scenarios[#scenarios+1] = { lr = 0.01;prev_lr = 0;alpha = 0.95;lr_decay = 0;weight_decay = 0; lr_list = nil ;emb_size = 128;hidden_size = 512;num_of_hidden=1;out_size = 128;gate_type = 'LSTM';momentum=0.5; threshold = 50 ;dump_frq = 50;max_epoch = 50;epoch=0;batch_size = 100;init = 1;max_seq_len = max_sentence_len;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;err_test_size = 1000;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10;coefL1=0;coefL2=0;fhead="";dropoutProb=0.5}

--scenarios[#scenarios+1] = { lr = 0.001;prev_lr = 0.01;alpha = 0.95;lr_decay = 0;weight_decay = 0; lr_list = nil ;emb_size = 128;hidden_size = 512;num_of_hidden=1;out_size = 128;gate_type = 'LSTM';momentum=0.5; threshold = 50 ;dump_frq = 50;max_epoch = 400;epoch=50;batch_size = 100;init = 1;max_seq_len = max_sentence_len;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;err_test_size = 1000;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10;coefL1=0;coefL2=0;fhead="";dropoutProb=0.5}

--scenarios[#scenarios+1] = { lr = 0.0001;prev_lr = 0.001;alpha = 0.95;lr_decay = 0;weight_decay = 0; lr_list = nil ;emb_size = 128;hidden_size = 512;num_of_hidden=1;out_size = 128;gate_type = 'LSTM';momentum=0.5; threshold = 50 ;dump_frq = 50;max_epoch = 2000;epoch=400;batch_size = 100;init = 1;max_seq_len = max_sentence_len;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;err_test_size = 1000;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10;coefL1=0;coefL2=0;fhead="";dropoutProb=0.5}

--scenarios[#scenarios+1] = { lr = 0.0001;prev_lr = 0.0001;alpha = 0.95;lr_decay = 0;weight_decay = 0; lr_list = nil ;emb_size = 128;hidden_size = 512;num_of_hidden=1;out_size = 128;gate_type = 'LSTM';momentum=0.5; threshold = 50 ;dump_frq = 50;max_epoch = 5000;epoch=2000;batch_size = 100;init = 1;max_seq_len = max_sentence_len;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;err_test_size = 1000;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10;coefL1=0;coefL2=0;fhead="";dropoutProb=0.5}

--scenarios[#scenarios+1] = { lr = 0.00001;prev_lr = 0.0001;alpha = 0.95;lr_decay = 0;weight_decay = 0; lr_list = nil ;emb_size = 128;hidden_size = 512;num_of_hidden=1;out_size = 128;gate_type = 'LSTM';momentum=0.5; threshold = 50 ;dump_frq = 50;max_epoch = 10000;epoch=4500;batch_size = 100;init = 1;max_seq_len = max_sentence_len;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;err_test_size = 1000;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10;coefL1=0;coefL2=0;fhead="";dropoutProb=0.5}

--for 10000 BISCAVG 1 
--scenarios[#scenarios+1] = { lr = 0.01;prev_lr = 0;alpha = 0.95;lr_decay = 0;weight_decay = 0; lr_list = nil ;emb_size = 128;hidden_size = 256;num_of_hidden=1;out_size = 128;gate_type = 'LSTM';short_cut=1;momentum=0.5; threshold = 50 ;dump_frq = 10;max_epoch = 170;epoch=0;batch_size = 100;init = 1;max_seq_len = max_sentence_len;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;err_test_size = 1000;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10;coefL1=0;coefL2=0;fhead="";dropoutProb=0.5}

--scenarios[#scenarios+1] = { lr = 0.001;prev_lr = 0.01;alpha = 0.95;lr_decay = 0;weight_decay = 0; lr_list = nil ;emb_size = 128;hidden_size = 256;num_of_hidden=1;out_size = 128;gate_type = 'LSTM';short_cut=1;momentum=0.5; threshold = 50 ;dump_frq = 50;max_epoch = 450;epoch=170;batch_size = 100;init = 1;max_seq_len = max_sentence_len;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;err_test_size = 1000;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10;coefL1=0;coefL2=0;fhead="";dropoutProb=0.5}

--scenarios[#scenarios+1] = { lr = 0.0001;prev_lr = 0.001;alpha = 0.95;lr_decay = 0;weight_decay = 0; lr_list = nil ;emb_size = 128;hidden_size = 256;num_of_hidden=1;out_size = 128;gate_type = 'LSTM';short_cut=1;momentum=0.5; threshold = 50 ;dump_frq = 50;max_epoch = 2000;epoch=450;batch_size = 100;init = 1;max_seq_len = max_sentence_len;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;err_test_size = 1000;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10;coefL1=0;coefL2=0;fhead="";dropoutProb=0.5}

--for 10000 BISCAVG 1 
--scenarios[#scenarios+1] = { lr = 0.01;prev_lr = 0;alpha = 0.95;lr_decay = 0;weight_decay = 0; lr_list = nil ;emb_size = 64;hidden_size = 128;num_of_hidden=1;out_size = 128;gate_type = 'LSTM';short_cut=1;momentum=0.5; threshold = 50 ;dump_frq = 50;plot_frq = 10;max_epoch = 250;epoch=0;batch_size = 50;init = 1;max_seq_len = max_sentence_len;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;err_test_size = 1000;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10;coefL1=0;coefL2=0;fhead="";dropoutProb=0.5}

scenarios[#scenarios+1] = { lr = 0.001;prev_lr = 0.01;alpha = 0.95;lr_decay = 0;weight_decay = 0; lr_list = nil ;emb_size = 64;hidden_size = 128;num_of_hidden=1;out_size = 128;gate_type = 'LSTM';short_cut=1;momentum=0.5; threshold = 50 ;dump_frq = 50;plot_frq = 10;max_epoch = 2000;epoch=250;batch_size = 50;init = 1;max_seq_len = max_sentence_len;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;err_test_size = 1000;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10;coefL1=0;coefL2=0;fhead="";dropoutProb=0.5}

--scenarios[#scenarios+1] = { lr = 0.0001;prev_lr = 0.001;alpha = 0.95;lr_decay = 0;weight_decay = 0; lr_list = nil ;emb_size = 64;hidden_size = 128;num_of_hidden=1;out_size = 128;gate_type = 'LSTM';short_cut=1;momentum=0.5; threshold = 50 ;dump_frq = 50;plot_frq = 10;max_epoch = 2000;epoch=800;batch_size = 50;init = 1;max_seq_len = max_sentence_len;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;err_test_size = 1000;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10;coefL1=0;coefL2=0;fhead="";dropoutProb=0.5}

else
  --for 10000 BIAVG 1 morph 
--scenarios[#scenarios+1] = { lr = 0.01;prev_lr = 0;alpha = 0.95;lr_decay = 0;weight_decay = 0; lr_list = nil ;emb_size = 128;hidden_size = 512;num_of_hidden=1;out_size = 128;gate_type = 'LSTM';momentum=0.5; threshold = 50 ;dump_frq = 50;max_epoch = 100;epoch=0;batch_size = 50;init = 1;max_seq_len = max_sentence_len;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;err_test_size = 1000;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10;coefL1=0;coefL2=0;fhead="";dropoutProb=0.5}
 
--scenarios[#scenarios+1] = { lr = 0.001;prev_lr = 0.01;alpha = 0.95;lr_decay = 0;weight_decay = 0; lr_list = nil ;emb_size = 128;hidden_size = 512;num_of_hidden=1;out_size = 128;gate_type = 'LSTM';momentum=0.5; threshold = 50 ;dump_frq = 50;max_epoch = 200;epoch=100;batch_size = 50;init = 1;max_seq_len = max_sentence_len;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;err_test_size = 1000;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10;coefL1=0;coefL2=0;fhead="";dropoutProb=0.5}

--scenarios[#scenarios+1] = { lr = 0.001;prev_lr = 0.001;alpha = 0.95;lr_decay = 0;weight_decay = 0; lr_list = nil ;emb_size = 128;hidden_size = 512;num_of_hidden=1;out_size = 128;gate_type = 'LSTM';momentum=0.5; threshold = 50 ;dump_frq = 50;max_epoch = 5000;epoch=200;batch_size = 50;init = 1;max_seq_len = max_sentence_len;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;err_test_size = 1000;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10;coefL1=0;coefL2=0;fhead="";dropoutProb=0.5}

--scenarios[#scenarios+1] = { lr = 0.0001;prev_lr = 0.001;alpha = 0.95;lr_decay = 0;weight_decay = 0; lr_list = nil ;emb_size = 128;hidden_size = 512;num_of_hidden=1;out_size = 128;gate_type = 'LSTM';momentum=0.5; threshold = 50 ;dump_frq = 50;max_epoch = 1000;epoch=550;batch_size = 50;init = 1;max_seq_len = max_sentence_len;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;err_test_size = 1000;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10;coefL1=0;coefL2=0;fhead="";dropoutProb=0.5}

--scenarios[#scenarios+1] = { lr = 0.0001;prev_lr = 0.0001;alpha = 0.95;lr_decay = 0;weight_decay = 0; lr_list = nil ;emb_size = 128;hidden_size = 512;num_of_hidden=1;out_size = 128;gate_type = 'LSTM';short_cut=0;momentum=0.5; threshold = 50 ;dump_frq = 50;max_epoch = 2200;epoch=1000;batch_size = 50;init = 1;max_seq_len = max_sentence_len;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;err_test_size = 1000;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10;coefL1=0;coefL2=0;fhead="";dropoutProb=0.5}

--scenarios[#scenarios+1] = { lr = 0.00001;prev_lr = 0.0001;alpha = 0.95;lr_decay = 0;weight_decay = 0; lr_list = nil ;emb_size = 128;hidden_size = 512;num_of_hidden=1;out_size = 128;gate_type = 'LSTM';short_cut=0;momentum=0.5; threshold = 50 ;dump_frq = 50;max_epoch = 2350;epoch=2200;batch_size = 50;init = 1;max_seq_len = max_sentence_len;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;err_test_size = 1000;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10;coefL1=0;coefL2=0;fhead="";dropoutProb=0.5}

--scenarios[#scenarios+1] = { lr = 0.000001;prev_lr = 0.00001;alpha = 0.95;lr_decay = 0;weight_decay = 0; lr_list = nil ;emb_size = 128;hidden_size = 512;num_of_hidden=1;out_size = 128;gate_type = 'LSTM';short_cut=0;momentum=0.5; threshold = 50 ;dump_frq = 50;max_epoch = 5000;epoch=2350;batch_size = 50;init = 1;max_seq_len = max_sentence_len;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;err_test_size = 1000;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10;coefL1=0;coefL2=0;fhead="";dropoutProb=0.5}

--for 10000 BISCAVG 1 morph
--scenarios[#scenarios+1] = { lr = 0.01;prev_lr = 0;alpha = 0.95;lr_decay = 0;weight_decay = 0; lr_list = nil ;emb_size = 64;hidden_size = 128;num_of_hidden=1;out_size = 128;gate_type = 'LSTM';short_cut=1;momentum=0.5; threshold = 50 ;dump_frq = 50;plot_frq = 10;max_epoch = 350;epoch=0;batch_size = 100;init = 1;max_seq_len = max_sentence_len;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;err_test_size = 1000;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10;coefL1=0;coefL2=0;fhead="";dropoutProb=0.5}

--scenarios[#scenarios+1] = { lr = 0.001;prev_lr = 0.01;alpha = 0.95;lr_decay = 0;weight_decay = 0; lr_list = nil ;emb_size = 64;hidden_size = 128;num_of_hidden=1;out_size = 128;gate_type = 'LSTM';short_cut=1;momentum=0.5; threshold = 50 ;dump_frq = 50;plot_frq = 10;max_epoch = 800;epoch=350;batch_size = 100;init = 1;max_seq_len = max_sentence_len;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;err_test_size = 1000;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10;coefL1=0;coefL2=0;fhead="";dropoutProb=0.5}

scenarios[#scenarios+1] = { lr = 0.0001;prev_lr = 0.001;alpha = 0.95;lr_decay = 0;weight_decay = 0; lr_list = nil ;emb_size = 64;hidden_size = 128;num_of_hidden=1;out_size = 128;gate_type = 'LSTM';short_cut=1;momentum=0.5; threshold = 50 ;dump_frq = 50;plot_frq = 10;max_epoch = 3000;epoch=800;batch_size = 100;init = 1;max_seq_len = max_sentence_len;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;err_test_size = 1000;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10;coefL1=0;coefL2=0;fhead="";dropoutProb=0.5}

--scenarios[#scenarios+1] = { lr = 0.00001;prev_lr = 0.0001;alpha = 0.95;lr_decay = 0;weight_decay = 0; lr_list = nil ;emb_size = 64;hidden_size = 128;num_of_hidden=1;out_size = 128;gate_type = 'LSTM';short_cut=1;momentum=0.5; threshold = 50 ;dump_frq = 50;plot_frq = 10;max_epoch = 3000;epoch=2000;batch_size = 100;init = 1;max_seq_len = max_sentence_len;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;err_test_size = 1000;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10;coefL1=0;coefL2=0;fhead="";dropoutProb=0.5}
...
function prepareData(model,dataTable,cfg)
  local vectors = torch.zeros(dataTable:size()[1],2*cfg.emb_size):double():cuda()
...
if corpus_load == false then
  ...
  corpus2:get_dataBiLSTM()
  corpus2.b = nil
  trainInp2=corpus2.f:cuda()
...
function model_load(model,prm_list)
  ...
  model.biSeqSec = torch.load(mname..'.model')
...
for i=1,#scenarios do
  ...
  if morph == false then
    if prm_list["short_cut"] == 1 then
      prm_list["fhead"] = "BiLstmSc-Avg-drop-"..corpus1_str
    else
      prm_list["fhead"] = "BiLstm-Avg-drop-"..corpus1_str
    end
  else
    if prm_list["short_cut"] == 1 then
      prm_list["fhead"] = "BiLstmSc-Avg-drop-"..corpus1_str.."-morph"
    else
      prm_list["fhead"] = "BiLstm-Avg-drop-"..corpus1_str.."-morph"
    end
  end
  ...
  if prm_list["short_cut"] == 0 then
    print("model name : BiLangModelBiLSTMAvg2")
  else
    print("model name : BiLangModelBiLSTMScAvg2")
  end
