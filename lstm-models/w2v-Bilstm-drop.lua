...
function prepare_testdata(corpus1,corpus2,prm_list)
  ...
  for fcnt = 1,#fileList do
    ...
    if f1 and f2 then
      ...
      testinputs1,_ = testcorpus_shapedataBiLSTM(corpus1.vocab_map,testcorpus1):cuda()
      testinputs2,_ = testcorpus_shapedataBiLSTM(corpus2.vocab_map,testcorpus2):cuda()
...
function model_train(model,trInpPri,trInpSec,tstInpPri,tstInpSec,prm_list,stPri,stSec)
  ...
  for i =prm_list["epoch"]+1,prm_list["max_epoch"] do
    ...
    if i % prm_list["dump_frq"] == 0 then
      ...
      print(" prm size : "..paramsPri:size()[1].." -  grad size : "..gradParamsPri:size()[1])
    end
...
--for 10000 BISCAVG 1 
--scenarios[#scenarios+1] = { lr = 0.01;prev_lr = 0;alpha = 0.95;lr_decay = 0;weight_decay = 0; lr_list = nil ;emb_size = 64;hidden_size = 128;num_of_hidden=1;out_size = 128;gate_type = 'LSTM';short_cut=1;momentum=0.5; threshold = 50 ;dump_frq = 50;max_epoch = 450;epoch=0;batch_size = 50;init = 1;max_seq_len = max_sentence_len;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;err_test_size = 1000;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10;coefL1=0;coefL2=0;fhead="";dropoutProb=0.5}

scenarios[#scenarios+1] = { lr = 0.001;prev_lr = 0.01;alpha = 0.95;lr_decay = 0;weight_decay = 0; lr_list = nil ;emb_size = 64;hidden_size = 128;num_of_hidden=1;out_size = 128;gate_type = 'LSTM';short_cut=1;momentum=0.5; threshold = 50 ;dump_frq = 50;max_epoch = 2000;epoch=450;batch_size = 50;init = 1;max_seq_len = max_sentence_len;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;err_test_size = 1000;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10;coefL1=0;coefL2=0;fhead="";dropoutProb=0.5}
...
--scenarios[#scenarios+1] = { lr = 0.01;prev_lr = 0;alpha = 0.95;lr_decay = 0;weight_decay = 0; lr_list = nil ;emb_size = 64;hidden_size = 128;num_of_hidden=1;out_size = 128;gate_type = 'LSTM';short_cut=1;momentum=0.5; threshold = 50 ;dump_frq = 50;max_epoch = 200;epoch=0;batch_size = 100;init = 1;max_seq_len = max_sentence_len;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;err_test_size = 1000;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10;coefL1=0;coefL2=0;fhead="";dropoutProb=0.5}

--scenarios[#scenarios+1] = { lr = 0.001;prev_lr = 0.01;alpha = 0.95;lr_decay = 0;weight_decay = 0; lr_list = nil ;emb_size = 64;hidden_size = 128;num_of_hidden=1;out_size = 128;gate_type = 'LSTM';short_cut=1;momentum=0.5; threshold = 50 ;dump_frq = 50;max_epoch = 850;epoch=200;batch_size = 100;init = 1;max_seq_len = max_sentence_len;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;err_test_size = 1000;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10;coefL1=0;coefL2=0;fhead="";dropoutProb=0.5}

--scenarios[#scenarios+1] = { lr = 0.0001;prev_lr = 0.001;alpha = 0.95;lr_decay = 0;weight_decay = 0; lr_list = nil ;emb_size = 64;hidden_size = 128;num_of_hidden=1;out_size = 128;gate_type = 'LSTM';short_cut=1;momentum=0.5; threshold = 50 ;dump_frq = 50;max_epoch = 1300;epoch=850;batch_size = 100;init = 1;max_seq_len = max_sentence_len;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;err_test_size = 1000;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10;coefL1=0;coefL2=0;fhead="";dropoutProb=0.5}

scenarios[#scenarios+1] = { lr = 0.00001;prev_lr = 0.0001;alpha = 0.95;lr_decay = 0;weight_decay = 0; lr_list = nil ;emb_size = 64;hidden_size = 128;num_of_hidden=1;out_size = 128;gate_type = 'LSTM';short_cut=1;momentum=0.5; threshold = 50 ;dump_frq = 50;max_epoch = 2000;epoch=1300;batch_size = 100;init = 1;max_seq_len = max_sentence_len;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;err_test_size = 1000;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10;coefL1=0;coefL2=0;fhead="";dropoutProb=0.5}
...
if corpus_load == false then
  ...
  corpus1:get_dataBiLSTM()
  corpus2:get_dataBiLSTM()
  corpus1.b = nil
  corpus2.b = nil
  trainInp1=corpus1.f:cuda()
...
function model_load(model,prm_list)
  ...
  print("model to be loaded : "..mname.."\n")
  model.biSeqPri = torch.load(mname..'.model')
...
for i=1,#scenarios do
  ...
  if morph == false then
    if prm_list["short_cut"] == 1 then
      prm_list["fhead"] = "BiLstmSc-Avg-drop-"..config.dsize
    else
      prm_list["fhead"] = "BiLstm-Avg-drop-"..config.dsize
    end
  else
    if prm_list["short_cut"] == 1 then
      prm_list["fhead"] = "BiLstmSc-Avg-drop-"..config.dsize.."-morph"
    else
      prm_list["fhead"] = "BiLstm-Avg-drop-"..config.dsize.."-morph"
    end
  end
  ...
  loss_logger = optim.Logger(""..prm_list["fhead"]..'_loss_log_'..i..'-'..prm_list["lr"]..'-'..prm_list["hidden_size"]..'-'..prm_list["max_seq_len"],true,prepheadstr(prm_list))
  ...
  score_logger = optim.Logger(""..prm_list["fhead"]..'_score_log_'..i..'-'..prm_list["lr"]..'-'..prm_list["hidden_size"]..'-'..prm_list["max_seq_len"],true,prepheadstr(prm_list))
