...
-- -dtype tok -dsize 10000 -corpus_load 1 -model_save 1 -model_load 0 -max_sntc_len 60 -layer 0
config = {}
...
cmd:option("-layer", config.layer)
cmd:option("-attn", config.attn)
...
if config.layer == 2 then
--scenarios[#scenarios+1] = { lr = 0.01;prev_lr = 0;alpha = 0.95;lr_decay = 0;weight_decay = 0; lr_list = nil ;emb_size = 64;hidden_size = 256;num_of_hidden=1;out_size = 64;gate_type = 'GRU';momentum=0.5; threshold = 50 ;dump_frq = 50;plot_frq = 10;max_epoch = 50;epoch=0;batch_size = 50;init = 0.01;max_seq_len = max_sentence_len;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;err_test_size = 1000;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10;coefL1=0;coefL2=0;fhead=""}

scenarios[#scenarios+1] = { lr = 0.001;prev_lr = 0.01;alpha = 0.95;lr_decay = 0;weight_decay = 0; lr_list = nil ;emb_size = 64;hidden_size = 256;num_of_hidden=1;out_size = 64;gate_type = 'GRU';momentum=0.5; threshold = 50 ;dump_frq = 50;plot_frq = 10;max_epoch = 5000;epoch=50;batch_size = 50;init = 0.01;max_seq_len = max_sentence_len;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;err_test_size = 1000;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10;coefL1=0;coefL2=0;fhead=""}

end

if config.layer == 3 then
scenarios[#scenarios+1] = { lr = 0.01;prev_lr = 0;alpha = 0.95;lr_decay = 0;weight_decay = 0; lr_list = nil ;emb_size = 64;hidden_size = 256;num_of_hidden=1;out_size = 64;gate_type = 'GRU';momentum=0.5; threshold = 50 ;dump_frq = 50;plot_frq = 10;max_epoch = 5000;epoch=0;batch_size = 50;init = 0.01;max_seq_len = max_sentence_len;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;err_test_size = 1000;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10;coefL1=0;coefL2=0;fhead=""}

end

if config.layer == 0 then
--for 10000 new 1
--batch_size = 50;init = 1 weight_decay = 1e-4 lr_decay = 1e-4 lr = 0.01
--scenarios[#scenarios+1] = { lr = 0.01;prev_lr = 0;alpha = 0.95;lr_decay = 1e-4;weight_decay = 0; lr_list = nil ;emb_size = 128;hidden_size = 128;momentum=0.5; threshold = 50 ;dump_frq = 50;max_epoch = 50;epoch=0;batch_size = 100;init = 1;max_seq_len = max_sentence_len;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;err_test_size = 1000;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10;coefL1=0;coefL2=0;fhead=""}

--scenarios[#scenarios+1] = { lr = 0.001;prev_lr = 0.01;alpha = 0.95;lr_decay = 1e-4;weight_decay = 0; lr_list = nil ;emb_size = 128;hidden_size = 128;momentum=0.5; threshold = 50 ;dump_frq = 50;max_epoch = 5000;epoch=50;batch_size = 100;init = 1;max_seq_len = max_sentence_len;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;err_test_size = 1000;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10;coefL1=0;coefL2=0;fhead=""}
...
-- for all 1
--scenarios[#scenarios+1] = { lr = 0.01;prev_lr = 0;alpha = 0.95;lr_decay = 1e-4;weight_decay = 0; lr_list = nil ;emb_size = 128;hidden_size = 128;num_of_hidden=2;momentum=0.5; threshold = 50 ;dump_frq = 50;plot_frq = 10;max_epoch = 2000;epoch=0;batch_size = 100;init = 1;max_seq_len = max_sentence_len;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;err_test_size = 1000;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10;coefL1=0;coefL2=0;fhead="";dropoutProb=0.9}

--for 10000 new 1
--batch_size = 50;init = 1 weight_decay = 1e-4 lr_decay = 1e-4 lr = 0.01
scenarios[#scenarios+1] = { lr = 0.01;prev_lr = 0;alpha = 0.95;lr_decay = 1e-4;weight_decay = 0; lr_list = nil ;emb_size = 128;hidden_size = 128;num_of_hidden=2;momentum=0.5; threshold = 50 ;dump_frq = 50;max_epoch = 2000;epoch=0;batch_size = 100;init = 1;max_seq_len = max_sentence_len;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;err_test_size = 1000;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10;coefL1=0;coefL2=0;fhead=""}

end

-- for all 1
--scenarios[#scenarios+1] = { lr = 0.01;prev_lr = 0;alpha = 0.95;lr_decay = 1e-4;weight_decay = 0; lr_list = nil ;emb_size = 128;hidden_size = 128;num_of_hidden=3;momentum=0.5; threshold = 50 ;dump_frq = 50;max_epoch = 200;epoch=0;batch_size = 100;init = 1;max_seq_len = max_sentence_len;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;err_test_size = 1000;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10;coefL1=0;coefL2=0;fhead="";dropoutProb=0.5}

-- for all 2
--scenarios[#scenarios+1] = { lr = 0.001;prev_lr = 0.01;alpha = 0.95;lr_decay = 1e-4;weight_decay = 0; lr_list = nil ;emb_size = 128;hidden_size = 128;num_of_hidden=3;momentum=0.5; threshold = 50 ;dump_frq = 50;max_epoch = 5000;epoch=200;batch_size = 100;init = 1;max_seq_len = max_sentence_len;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;err_test_size = 1000;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10;coefL1=0;coefL2=0;fhead="";dropoutProb=0.5}
...
--for all morph new 1
--scenarios[#scenarios+1] = { lr = 0.01;prev_lr = 0;alpha = 0.95;lr_decay = 1e-4;weight_decay = 0; lr_list = nil ;emb_size = 128;hidden_size = 128;num_of_hidden=2;momentum=0.5; threshold = 50 ;dump_frq = 50;plot_frq = 10;max_epoch = 2000;epoch=0;batch_size = 100;init = 1;max_seq_len = max_sentence_len;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok.morph";testcorpus2 = "turkish.10000.tok.morph";test_size = 100;err_test_size = 1000;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10;coefL1=0.01;coefL2=0.01;fhead="";dropoutProb=0.9}
...
function prepheadstr(prm_list)
  str = string.format("%s-%s-%d-%d-lr=%3.7f-lr_decay=%3.7f-w_decay=%3.7f-max_epoch=%d-batch_size=%d-init=%1.4f-max_seq_len=%d-win_size=%d-attn=%d" ,prm_list["fhead"],prm_list["opm_name"],prm_list["emb_size"],prm_list["hidden_size"],prm_list["lr"],prm_list["lr_decay"],prm_list["weight_decay"],prm_list["max_epoch"],prm_list["batch_size"],prm_list["init"],prm_list["max_seq_len"],prm_list["win_size"],config.attn)
  return str
end
...
if morph == false then
  if config.layer == 0 then
    if config.attn == 0 then
      prm_list["fhead"] = "lstm-ScAvg-drop-"..config.dsize
    else
      prm_list["fhead"] = "lstm-ScAvg-drop-attn"..config.dsize
    end
  end
  if config.layer == 2 then
    prm_list["fhead"] = "lstm2lyr-ScAvg-drop-"..config.dsize
  end
  if config.layer == 3 then
    prm_list["fhead"] = "lstm3lyr-ScAvg-drop-"..config.dsize
  end
else
  if config.layer == 0 then
    if config.attn == 0 then
      prm_list["fhead"] = "lstm-ScAvg-drop-"..config.dsize.."-morph"
    else
      prm_list["fhead"] = "lstm-ScAvg-drop-attn"..config.dsize.."-morph"
    end
  end
  if config.layer == 2 then
    prm_list["fhead"] = "lstm2lyr-ScAvg-drop-"..config.dsize.."-morph"
  end
  if config.layer == 3 then
    prm_list["fhead"] = "lstm3lyr-ScAvg-drop-"..config.dsize.."-morph"
  end
end
  ...
  if config.layer == 0 then
    if config.attn == 0 then
      ...
      modelLSTM = BiLangModelLSTMScAttnAvg(vocab_size1,vocab_size2,seq_len1,seq_len2,prm_list)  
    end
  end
  if config.layer == 2 then
  ...
  if config.layer == 0 then
    if config.attn == 0 then
      ...
      print("model name : BiLangModelLSTMScAttnAvg")
    end
  end
  if config.layer == 2 then
    print("model name : BiLangModelLSTM2LyScAvg")
  end
  if config.layer == 3 then
    print("model name : BiLangModelLSTM3LyScAvg")
  end
