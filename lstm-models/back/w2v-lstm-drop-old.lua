...
if morph == false then
  ...
  corpus_name_pri = "english.10000.tok.morph"
  corpus_name_sec = "turkish.10000.tok.morph"
  fhead = "lstm-avg-drop-10000-morph"
end
...
--for 1000  new  1
--scenarios[#scenarios+1] = { lr = 0.001;prev_lr = 0;alpha = 0.95;lr_decay = 1; lr_list = nil ;emb_size = 64;hidden_size = 128;momentum=0.5; threshold = 50 ;dump_frq = 50;max_epoch = 1450;epoch=0;batch_size = 50;init = 1;max_seq_len = 30;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.1000.tok";testcorpus2 = "turkish.1000.tok";test_size = 100;out_file = "test-lstm-1000.txt"; dsize ="1000";max_cv = 10}

--for 1000  new 2
--scenarios[#scenarios+1] = { lr = 0.001;prev_lr = 0.001;alpha = 0.95;lr_decay = 1; lr_list = nil ;emb_size = 64;hidden_size = 128;momentum=0.5; threshold = 50 ;dump_frq = 50;max_epoch = 3000;epoch=1450;batch_size = 50;init = 1;max_seq_len = 30;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.1000.tok";testcorpus2 = "turkish.1000.tok";test_size = 100;out_file = "test-lstm-1000.txt"; dsize ="1000";max_cv = 10}

--for 1000  new 3
--scenarios[#scenarios+1] = { lr = 0.0008;prev_lr = 0.001;alpha = 0.95;lr_decay = 1; lr_list = nil ;emb_size = 64;hidden_size = 128;momentum=0.5; threshold = 50 ;dump_frq = 50;max_epoch = 2550;epoch=1650;batch_size = 50;init = 1;max_seq_len = 30;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.1000.tok";testcorpus2 = "turkish.1000.tok";test_size = 100;out_file = "test-lstm-1000.txt"; dsize ="1000";max_cv = 10}

--for 1000  new 4  
--scenarios[#scenarios+1] = { lr = 0.0001;prev_lr = 0.0008;alpha = 0.95;lr_decay = 1; lr_list = nil ;emb_size = 64;hidden_size = 128;momentum=0.5; threshold = 50 ;dump_frq = 50;max_epoch = 3000;epoch=1800;batch_size = 50;init = 1;max_seq_len = 30;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.1000.tok";testcorpus2 = "turkish.1000.tok";test_size = 100;out_file = "test-lstm-1000.txt"; dsize ="1000";max_cv = 10}

--for 1000  new 5  ****
--scenarios[#scenarios+1] = { lr = 0.0001;prev_lr = 0.0001;alpha = 0.95;lr_decay = 1; lr_list = nil ;emb_size = 64;hidden_size = 128;momentum=0.5; threshold = 50 ;dump_frq = 50;max_epoch = 20000;epoch=3000;batch_size = 50;init = 1;max_seq_len = 30;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.1000.tok";testcorpus2 = "turkish.1000.tok";test_size = 100;out_file = "test-lstm-1000.txt"; dsize ="1000";max_cv = 10}


--for 1000 morph new 1
--scenarios[#scenarios+1] = { lr = 0.001;prev_lr = 0;alpha = 0.95;lr_decay = 1; lr_list = nil ;emb_size = 64;hidden_size = 128;momentum=0.5; threshold = 50 ;dump_frq = 50;max_epoch = 1150;epoch=0;batch_size = 50;init = 1;max_seq_len = 30;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.1000.tok";testcorpus2 = "turkish.1000.tok";test_size = 100;out_file = "test-lstm-1000.txt"; dsize ="1000";max_cv = 10}

--for 1000 morph new 2
--scenarios[#scenarios+1] = { lr = 0.0005;prev_lr = 0.001;alpha = 0.95;lr_decay = 1; lr_list = nil ;emb_size = 64;hidden_size = 128;momentum=0.5; threshold = 50 ;dump_frq = 50;max_epoch = 1350;epoch=1150;batch_size = 50;init = 1;max_seq_len = 30;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.1000.tok.morph";testcorpus2 = "turkish.1000.tok.morph";test_size = 100;out_file = "test-lstm-1000.txt"; dsize ="1000";max_cv = 10}

--for 1000 morph new 3
--scenarios[#scenarios+1] = { lr = 0.0001;prev_lr = 0.0005;alpha = 0.95;lr_decay = 1; lr_list = nil ;emb_size = 64;hidden_size = 128;momentum=0.5; threshold = 50 ;dump_frq = 50;max_epoch = 15000;epoch=1350;batch_size = 50;init = 1;max_seq_len = 30;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.1000.tok.morph";testcorpus2 = "turkish.1000.tok.morph";test_size = 100;out_file = "test-lstm-1000.txt"; dsize ="1000";max_cv = 10}

--for 10000 new 1
--scenarios[#scenarios+1] = { lr = 0.0001;prev_lr = 0;alpha = 0.95;lr_decay = 1; lr_list = nil ;emb_size = 64;hidden_size = 128;momentum=0.5; threshold = 50 ;dump_frq = 50;max_epoch = 2000;epoch=0;batch_size = 50;init = 1;max_seq_len = 30;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10}

--for 10000 new 2 
--scenarios[#scenarios+1] = { lr = 0.0001;prev_lr = 0.0001;alpha = 0.95;lr_decay = 1; lr_list = nil ;emb_size = 64;hidden_size = 128;momentum=0.5; threshold = 50 ;dump_frq = 50;max_epoch = 5000;epoch=2000;batch_size = 50;init = 1;max_seq_len = 30;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10;coefL1=0;coefL2=0}

--for 10000 new 3 ****
scenarios[#scenarios+1] = { lr = 0.0001;prev_lr = 0.0001;alpha = 0.95;lr_decay = 1; lr_list = nil ;emb_size = 64;hidden_size = 128;momentum=0.5; threshold = 50 ;dump_frq = 50;max_epoch = 10000;epoch=5000;batch_size = 50;init = 1;max_seq_len = 30;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10;coefL1=0.01;coefL2=0.01}
