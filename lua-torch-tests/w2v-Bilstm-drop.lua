...
function model_train(model,trInpPri,trInpSec,trInpPriR,trInpSecR,tstInpPri,tstInpSec,tstInpPriR,tstInpSecR,prm_list)
...
--BI for 1000  new  2 ok
--scenarios[#scenarios+1] = { lr = 0.0001;prev_lr = 0.001;alpha = 0.95;lr_decay = 1; lr_list = nil ;emb_size = 64;hidden_size = 128;momentum=0.5; threshold = 50 ;dump_frq = 50;max_epoch = 2000;epoch=150;batch_size = 50;init = 1;max_seq_len = 10;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.1000.tok";testcorpus2 = "turkish.1000.tok";test_size = 100;out_file = "test-lstm-1000.txt"; dsize ="1000";max_cv = 10}

--BI for 1000  new  3 ok
--scenarios[#scenarios+1] = { lr = 0.00001;prev_lr = 0.0001;alpha = 0.95;lr_decay = 1; lr_list = nil ;emb_size = 64;hidden_size = 128;momentum=0.5; threshold = 50 ;dump_frq = 50;max_epoch = 2000;epoch=300;batch_size = 50;init = 1;max_seq_len = 10;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.1000.tok";testcorpus2 = "turkish.1000.tok";test_size = 100;out_file = "test-lstm-1000.txt"; dsize ="1000";max_cv = 10}

--BI for 10000 new 1
--scenarios[#scenarios+1] = { lr = 0.000001;prev_lr = 0;alpha = 0.95;lr_decay = 1; lr_list = nil ;emb_size = 64;hidden_size = 128;momentum=0.5; threshold = 100 ;dump_frq = 50;max_epoch = 500;epoch=0;batch_size = 100;init = 1;max_seq_len = 10;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10}

--BI for 10000 new 2
--scenarios[#scenarios+1] = { lr = 0.000001;prev_lr = 0.000001;alpha = 0.95;lr_decay = 1; lr_list = nil ;emb_size = 64;hidden_size = 128;momentum=0.5; threshold = 100 ;dump_frq = 50;max_epoch = 1500;epoch=500;batch_size = 100;init = 1;max_seq_len = 10;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10}

--BI for 10000 new 1
scenarios[#scenarios+1] = { lr = 0.000001;prev_lr = 0;alpha = 0.95;lr_decay = 1; lr_list = nil ;emb_size = 64;hidden_size = 128;momentum=0.5; threshold = 100 ;dump_frq = 50;max_epoch = 5000;epoch=0;batch_size = 100;init = 1;max_seq_len = 30;win_size = 1;opm_name = 'rmsprop';opm = optim.rmsprop; train_score = 0;test_score = 0;num_of_samples = 0;testcorpus1 = "english.10000.tok";testcorpus2 = "turkish.10000.tok";test_size = 100;out_file = "test-lstm-10000.txt"; dsize ="1000";max_cv = 10}
...
for i=1,#scenarios do
  ...
  modelLSTM = model_train(modelLSTM,trainInp1,trainInp2,trainInp1r,trainInp2r,testInp1,testInp2,testInp1r,testInp2r,prm_list)
  print(" testing train data ..\n")
  prm_list["train_score"] = test_model_cv(modelLSTM,trainInp1,trainInp2,trainInp1r,trainInp2r,prm_list)
  print(" testing test data ..\n")
  prm_list["test_score"] = test_model_cv(modelLSTM,testInp1,testInp2,testInp1r,testInp2r,prm_list)
