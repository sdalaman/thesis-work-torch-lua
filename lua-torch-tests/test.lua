...
print(b('jacobian[1]:')); print(jacobian[1]);print(gradInput[1] - jacobian[1])
print(b('jacobian[2]:')); print(jacobian[2]);print(gradInput[1] - jacobian[1])
print(b('jacobian[3]:')); print(jacobian[3]);print(gradInput[1] - jacobian[1])
